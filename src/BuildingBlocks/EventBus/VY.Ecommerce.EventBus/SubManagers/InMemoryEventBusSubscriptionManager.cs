...
namespace VY.Ecommerce.EventBus.Base.SubManagers
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        private void AddSubscription(Type handlerType, string eventName)
        {
            ...
            {
                throw new ArgumentException($"Handler Type {handlerType.Name} already registred for '{eventName}'", nameof(handlerType));
            }
